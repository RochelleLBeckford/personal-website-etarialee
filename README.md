# personal-website-etarialee
<!-- & This creates a banner for the ReadMe -->
<img src="img/a-header/retro-pixel-geisha-under-the-cherry-blossom tree.png" alt="Retro Pixel Geisha Under The Cherry Blossom Tree" width="100%" height="400">

# <p align="center">🌸 Personal Website: I'm EtariaLee, Frontend Developer 🌸</p>

## Practice: Creating a Webpage building upon HTML basics and understanding how to use CSS Basics

### Understanding CSS -> Bringing to life an my personal website.

<hr>

## <p align="center">💫 Overview</p>
-   [ ] This is a warmly inviting personal portfolio website for myselg, EtariaLee a frontend developer. This website blends and showcases my journey, skills, and projects. It feels like a friendly conversation starter, and I welcome any visitors to explore my work and connect with me.

<hr>

## <p align="center">🎨 Key Design Features</p>
-   [ ] <b>Cherry Blossom theme</b> wraps the whole page in soft purples, mint greens, cherry blossom scheme like walking through a spring garden against the night sky.
-   [ ] <b>Custom Gradient Dividers</b> separates each section with flowing pinks and greens like silk ribbons elegantly seperating the header, main sections, and footer of the webpage.
-   [ ] <b>Flexbox Layout</b> keeps the header and footer perfectily balancedm with vintage pixel geishas flanking every page
-   [ ] <b>Responsive Project Gallery Grid</b> lets the projects breathe, each piece paired with its own link to GitHub and Live
Demo for each project, side by side like scrolls unfurling
-   [ ] <b>Interactive Navigation</b> gently guides the visitor from the about section to the project to a friendly conversation that can arise from contacting me
-   [ ] <b>Contact Form</b> invites visitors to reach out and get in touch with me
...
-   [ ] The visual examples of the webpage:
    ...
    -   [ ] <img src="img/d-readme/visual-project-section.png" alt="Visual Example of Project Gallery Section" width="500" height="450">
    -   [ ] <img src="img/d-readme/visual-contact-footer-section.png" alt="Visual Example of Contact Us and Footer Section" width="500" height="450">
